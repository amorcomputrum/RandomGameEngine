...
namespace RGE{
	namespace physics{
		struct DetectCollision{
			...
			static std::vector<int> LinevsCircleLoc(float x1, float y1, float x2, float y2, float cx, float cy, float r);

			static std::vector<int> LinevsLineLoc(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4);

			static std::vector<int> LinevsRectLoc(float x1, float y1, float x2, float y2, float rx, float ry, float rw, float rh, int d);
		};
	}
}
